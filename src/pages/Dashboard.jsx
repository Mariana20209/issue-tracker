...
const Dashboard = () => {
    ...
    const incidenciasFiltradas = incidencias
        .filter(inc => inc.titulo.toLowerCase().includes(busqueda.toLowerCase()))
        .filter(inc => filtroEstado === 'Todos' ? true : inc.estado === filtroEstado)
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="max-w-6xl mx-auto px-4 py-8">
                ...
                <div className="flex gap-2 mb-6 flex-wrap">
                    {['Todos', 'Pendiente', 'En Progreso', 'Resuelto'].map(estado => (
                        <button
                            key={estado}
                            onClick={() => setFiltroEstado(estado)}
                            className={`px-4 py-2 rounded-full text-sm font-medium transition-colors ${filtroEstado === estado
